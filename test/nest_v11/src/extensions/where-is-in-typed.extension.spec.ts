...
setupTest('where-is-in.whereIsIn', undefined, (context) => {
  it('SHOULD apply where IN correctly', async () => {
    ...
    const whereInQuery = selectQuery.whereIsInTyped((u) => u.id, [1, 3, 5, 7, 9]);
  ...
  it('SHOULD return empty array when no matches', async () => {
    ...
    const selectQuery = usersRepository.createQueryBuilder('user');
    const whereInQuery = selectQuery.whereIsInTyped((u) => u.id, [11, 12, 13]);
  ...
  it('SHOULD handle empty array input', async () => {
    ...
    const selectQuery = usersRepository.createQueryBuilder('user');
    const whereInQuery = selectQuery.whereIsInTyped((u) => u.id, []);
...
setupTest('where-is-in.whereIsNotIn', undefined, (context) => {
  it('SHOULD apply where NOT IN correctly', async () => {
    ...
    const selectQuery = usersRepository.createQueryBuilder('user');
    const whereNotInQuery = selectQuery.whereIsNotInTyped((u) => u.id, [1, 3, 5, 7, 9]);
  ...
  it('SHOULD return all ids array when no conditions met', async () => {
    ...
    const selectQuery = usersRepository.createQueryBuilder('user');
    const whereNotInQuery = selectQuery.whereIsNotInTyped((u) => u.id, [11, 12, 13]);
  ...
  it('SHOULD return full list on empty array input', async () => {
    ...
    const selectQuery = usersRepository.createQueryBuilder('user');
    const whereNotInQuery = selectQuery.whereIsNotInTyped((u) => u.id, []);
